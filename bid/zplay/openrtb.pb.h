...
class NativeResponse_Asset_Video : public ::google::protobuf::Message {
 public:
  ...
  inline int vasttag_size() const;
  inline void clear_vasttag();
  static const int kVasttagFieldNumber = 1;
  inline const ::std::string& vasttag(int index) const;
  inline ::std::string* mutable_vasttag(int index);
  inline void set_vasttag(int index, const ::std::string& value);
  inline void set_vasttag(int index, const char* value);
  inline void set_vasttag(int index, const char* value, size_t size);
  inline ::std::string* add_vasttag();
  inline void add_vasttag(const ::std::string& value);
  inline void add_vasttag(const char* value);
  inline void add_vasttag(const char* value, size_t size);
  inline const ::google::protobuf::RepeatedPtrField< ::std::string>& vasttag() const;
  inline ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_vasttag();
...
inline void BidResponse::clear_cur() {
  if (cur_ != _default_cur_) {
    cur_->assign(*_default_cur_);
  }
  clear_has_cur();
}
...
inline ::std::string* BidResponse::mutable_cur() {
  set_has_cur();
  if (cur_ == _default_cur_) {
    cur_ = new ::std::string(*_default_cur_);
  }
...
inline ::std::string* BidResponse::release_cur() {
  ...
  if (cur_ == _default_cur_) {
    ...
    cur_ = const_cast< ::std::string*>(_default_cur_);
    return temp;
  }
}
